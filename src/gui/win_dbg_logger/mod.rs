...
pub fn output_debug_string(s: &str) {
  ...
  #[cfg(not(windows))]{let _ = s;}
}

#[cfg(windows)] extern "stdcall" {
...
pub fn is_debugger_present() -> bool {
  #[cfg(    windows) ]{unsafe {IsDebuggerPresent() != 0 }}
...
macro_rules! define_init_at_level {($func:ident, $level:ident) => {
  ...
  #[no_mangle] pub extern "C" fn $func() {init();log::set_max_level(LevelFilter::$level);}
 };
}
