...
impl fmt::Display for KeyCode {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    match self {
      ...
      KeyCode::Insert     	=> write!(f,"{:}" ,"⎀" ),KeyCode::Delete	=> write!(f,"{:}" ,"␡" ),
      KeyCode::Home       	=> write!(f,"{:}" ,"⇤" ),KeyCode::End   	=> write!(f,"{:}" ,"⇥" ),
      KeyCode::PgDown     	=> write!(f,"{:}" ,"⇟" ),KeyCode::PgUp  	=> write!(f,"{:}" ,"⇞" ),
      KeyCode::Down       	=> write!(f,"{:}" ,"▼" ),KeyCode::Up    	=> write!(f,"{:}" ,"▲" ),KeyCode::Right	=> write!(f,"{:}" ,"▶" ),KeyCode::Left	=> write!(f,"{:}" ,"◀" ),
      ...
      KeyCode::Kp0        	=> write!(f,"{:}" ,"🔢0" ),KeyCode::Kp1	=> write!(f,"{:}" ,"🔢1" ),KeyCode::Kp2	=> write!(f,"{:}" ,"🔢2" ),KeyCode::Kp3	=> write!(f,"{:}" ,"🔢3" ),KeyCode::Kp4	=> write!(f,"{:}" ,"🔢4" ),KeyCode::Kp5	=> write!(f,"{:}" ,"🔢5" ),KeyCode::Kp6	=> write!(f,"{:}" ,"🔢6" ),KeyCode::Kp7	=> write!(f,"{:}" ,"🔢7" ),KeyCode::Kp8	=> write!(f,"{:}" ,"🔢8" ),KeyCode::Kp9	=> write!(f,"{:}" ,"🔢9" ),
