...
fn parse_action_atom(ac_span: &Spanned<String>, s: &ParsedState) -> Result<&'static KanataAction> {
  ...
  match ac {
    ...
    "lrld"                     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::LiveReload)),)))}
    "lrld-next"|"lrnx"         	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::LiveReloadNext)),)))}
    "lrld-prev"|"lrpv"         	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::LiveReloadPrev)),)))}
    "sldr"                     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::SequenceLeader(s.default_sequence_timeout,s.default_sequence_input_mode,),)))))}
    "scnl"                     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::SequenceCancel)),)))}
    "mlft"|"mouseleft"         	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Mouse(Btn::Left))),)))}
    "mrgt"|"mouseright"        	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Mouse(Btn::Right))),)))}
    "mmid"|"mousemid"          	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Mouse(Btn::Mid))),)))}
    "mfwd"|"mouseforward"      	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Mouse(Btn::Forward))),)))}
    "mbck"|"mousebackward"     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Mouse(Btn::Backward))),)))}
    "mltp"|"mousetapleft"      	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MouseTap(Btn::Left))),)))}
    "mrtp"|"mousetapright"     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MouseTap(Btn::Right))),)))}
    "mmtp"|"mousetapmid"       	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MouseTap(Btn::Mid))),)))}
    "mftp"|"mousetapforward"   	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MouseTap(Btn::Forward))),)))}
    "mbtp"|"mousetapbackward"  	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MouseTap(Btn::Backward))),)))}
    "mwu"|"mousewheelup"       	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MWheelNotch {direction: MWheelDirection::Up,},)))))}
    "mwd"|"mousewheeldown"     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MWheelNotch {direction: MWheelDirection::Down,},)))))}
    "mwl"|"mousewheelleft"     	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MWheelNotch {direction: MWheelDirection::Left,},)))))}
    "mwr"|"mousewheelright"    	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::MWheelNotch {direction: MWheelDirection::Right,},)))))}
    "rpt"|"repeat"|"rpt-key"   	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::Repeat)),)))}
    "rpt-any"                  	=>  return Ok(s.a.sref(Action::Repeat)),
    "dynamic-macro-record-stop"	=> {return Ok(s.a.sref(Action::Custom(s.a.sref(s.a.sref_slice(CustomAction::DynamicMacroRecordStop(0))),)))}
    _ => {}};if let Some(oscode) = str_to_oscode(ac) {return Ok(s.a.sref(k(oscode.into())));}
