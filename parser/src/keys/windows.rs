...
#[allow(unused)]
mod keys {
    // modified from github.com/microsoft/windows-rs/blob/0.55.0/crates/libs/sys/src/Windows/Win32/UI/Input/KeyboardAndMouse/mod.rs
    // Category             Count  List
    ...
    // Alphanumeric
    pub const vk0: VirtualKey = 48u16;
    pub const vk1: VirtualKey = 49u16;
    pub const vk2: VirtualKey = 50u16;
    pub const vk3: VirtualKey = 51u16;
    pub const vk4: VirtualKey = 52u16;
    pub const vk5: VirtualKey = 53u16;
    pub const vk6: VirtualKey = 54u16;
    pub const vk7: VirtualKey = 55u16;
    pub const vk8: VirtualKey = 56u16;
    pub const vk9: VirtualKey = 57u16;
    ...
    pub const vk_oem1: VirtualKey = 186u16;
    pub const vk_oem2: VirtualKey = 191u16;
    pub const vk_oem3: VirtualKey = 192u16;
    pub const vk_oem4: VirtualKey = 219u16;
    pub const vk_oem5: VirtualKey = 220u16;
    pub const vk_oem6: VirtualKey = 221u16;
    pub const vk_oem7: VirtualKey = 222u16;
    pub const vk_oem8: VirtualKey = 223u16;
...
impl OsCode {
    pub(super) const fn from_u16_windows(code: u16) -> Option<Self> {
        match code {
            ...
            vk_oem1 => Some(OsCode::KEY_SEMICOLON),
            vk_oem2 => Some(OsCode::KEY_SLASH),
            vk_oem3 => Some(OsCode::KEY_GRAVE),
            vk_oem4 => Some(OsCode::KEY_LEFTBRACE),
            vk_oem5 => Some(OsCode::KEY_BACKSLASH),
            vk_oem6 => Some(OsCode::KEY_RIGHTBRACE),
            vk_oem7 => Some(OsCode::KEY_APOSTROPHE),
